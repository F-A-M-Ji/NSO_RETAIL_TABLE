...
from processing.retail_calculator_4digit import run_processing_pipeline_4digit
...
def main():
    ...
    if conn:
        try:
            run_processing_pipeline_4digit(conn)
...
if __name__ == "__main__":
    from config.app_config import INPUT_DIR, OUTPUT_DIR
